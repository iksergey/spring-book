...
Файл index.html переименован в start.html.
...
Когда пользователь зайдет на страницу по корневому URL http://localhost:11000/, Spring вызовет метод home(),
который вернет строку "start.html".